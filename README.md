...
### **Prerequisites**
- Node.js v18+
- Somnia Testnet STT tokens ([Get from faucet](https://testnet.somnia.network/) or [Request in Telegram](https://t.me/+XHq0F0JXMyhmMzM0))
- WalletConnect Project ID ([Get free at walletconnect.com](https://cloud.walletconnect.com/))
